...
└── ...
    ...
    Flux fluctuations are rebinned to a linear velocity bin.

Usage for skewers bounded by optical depths 0.001 and 100.0 with linear velocity
    rebinning from u=0 to u=10000.0 in du=200.0 increments:
    $ python3 powspec_skewer_range.py 0_skewers.h5 0.001 100.0 0. 10000.0 200.0 -v
