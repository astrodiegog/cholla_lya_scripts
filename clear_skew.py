...
def clear_taucalc(OTFSkewers, verbose=False):
    ...
    datasets2remove = ['taucalc_bool', 'taucalc_eff_1sig', 'taucalc_eff_3sig',
                        'taucalc_eff_5sig', 'taucalc_eff_8sig', 'taucalc_eff_10sig',
                        'taucalc_eff_allLOS', 'taucalc_local_1sig', 'taucalc_local_3sig',
