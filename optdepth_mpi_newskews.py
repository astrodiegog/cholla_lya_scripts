...
def taucalc(Skewers, skewCosmoCalc, comm, precision=np.float64, verbose=False, nopec=False):
    '''
...
def main():
    ...
    t_start = MPI.Wtime()
    taucalc(Skewers, skewCosmoCalc, comm, precision, args.verbose, args.peculiarless)
    t_end = MPI.Wtime()
